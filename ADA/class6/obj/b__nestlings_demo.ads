...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_nestlings_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#786c22b4#;
   pragma Export (C, u00001, "nestlings_demoB");
   ...
   u00121 : constant Version_32 := 16#d0396819#;
   pragma Export (C, u00121, "nestlingsB");
   u00122 : constant Version_32 := 16#ddcd78b4#;
   pragma Export (C, u00122, "nestlingsS");
