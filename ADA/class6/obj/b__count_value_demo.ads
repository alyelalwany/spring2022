...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_count_value_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f95908da#;
   pragma Export (C, u00001, "count_value_demoB");
   ...
   u00121 : constant Version_32 := 16#5a9f5ab5#;
   pragma Export (C, u00121, "count_valueB");
   u00122 : constant Version_32 := 16#f8039de7#;
   pragma Export (C, u00122, "count_valueS");
