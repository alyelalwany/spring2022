...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_morethanonce_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a834c4ed#;
   pragma Export (C, u00001, "morethanonce_demoB");
   ...
   u00121 : constant Version_32 := 16#9e239d6e#;
   pragma Export (C, u00121, "doubleslimitedB");
   u00122 : constant Version_32 := 16#73135064#;
   pragma Export (C, u00122, "doubleslimitedS");
   u00123 : constant Version_32 := 16#36cdc8b7#;
   pragma Export (C, u00123, "morethanonceB");
   u00124 : constant Version_32 := 16#d2b97ae4#;
   pragma Export (C, u00124, "morethanonceS");
