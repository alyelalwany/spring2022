...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_has_repetition_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3e66d8d0#;
   pragma Export (C, u00001, "has_repetition_demoB");
   ...
   u00121 : constant Version_32 := 16#eec37bf2#;
   pragma Export (C, u00121, "has_repetitionB");
   u00122 : constant Version_32 := 16#1a82e8ef#;
   pragma Export (C, u00122, "has_repetitionS");
