...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_reversal_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6f5bb9bb#;
   pragma Export (C, u00001, "reversal_demoB");
   ...
   u00121 : constant Version_32 := 16#f7e862e3#;
   pragma Export (C, u00121, "reversalgenB");
   u00122 : constant Version_32 := 16#dfb331a1#;
   pragma Export (C, u00122, "reversalgenS");
   u00123 : constant Version_32 := 16#145c2481#;
   pragma Export (C, u00123, "swapB");
   u00124 : constant Version_32 := 16#9c53c069#;
   pragma Export (C, u00124, "swapS");
   u00125 : constant Version_32 := 16#6a9b48f5#;
   pragma Export (C, u00125, "reversalgenlimitedB");
   u00126 : constant Version_32 := 16#0c0beb31#;
   pragma Export (C, u00126, "reversalgenlimitedS");
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  reversalgenlimited%s
   --  reversalgenlimited%b
   --  swap%s
   --  swap%b
   --  reversalgen%s
   --  reversalgen%b
