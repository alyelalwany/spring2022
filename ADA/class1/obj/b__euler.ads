...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_euler" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#67143046#;
   pragma Export (C, u00001, "eulerB");
   ...
   u00159 : constant Version_32 := 16#531a5141#;
   pragma Export (C, u00159, "mathB");
   u00160 : constant Version_32 := 16#77b3be3f#;
   pragma Export (C, u00160, "mathS");
