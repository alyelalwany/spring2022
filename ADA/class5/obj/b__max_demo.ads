...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_max_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9c4b53db#;
   pragma Export (C, u00001, "max_demoB");
   ...
   u00121 : constant Version_32 := 16#ccc03253#;
   pragma Export (C, u00121, "maximumB");
   u00122 : constant Version_32 := 16#43b3f56c#;
   pragma Export (C, u00122, "maximumS");
