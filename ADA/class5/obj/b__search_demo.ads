...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_search_demo" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#4b1297a6#;
   pragma Export (C, u00001, "search_demoB");
   ...
   u00121 : constant Version_32 := 16#54b670bd#;
   pragma Export (C, u00121, "searchB");
   u00122 : constant Version_32 := 16#c1930da0#;
   pragma Export (C, u00122, "searchS");
